...
impl Gost28147_89 {
    ...
    pub fn new() -> Gost28147_89 {
        ...
        substitution_box.copy_from_slice(&DEFAULT_SUBSTITUTION_BOX);
    ...
    pub fn set_key(&mut self, cipher_key: &[u32;8]) {
        for index in 0..32 {
            let round_key_position = ROUND_KEY_POSITION[index];
...
mod tests {
    ...
    fn initialization() {
        ...
        assert_eq!(gost.substitution_box, DEFAULT_SUBSTITUTION_BOX);
    }
