...
impl CryptoEngine {
    ...
    const SUBSTITUTION_BOX_CBR: [u8;128] = [
    ...
    const SUBSTITUTION_BOX_RFC7836: [u8;128] = [
    ...
    fn prepare_round_keys(&mut self) {
        for index in 0..32 {
            let round_key_position = CryptoEngine::ROUND_KEY_POSITION[index] as usize;
...
mod tests {
    ...
    fn encrypt_rfc5830() {
        /*
            ...
            https://www.rfc-editor.org/rfc/rfc5831
        ...
        */
        ...
        let mut gost = CryptoEngine::new();
        gost.set_substitution_box(&CryptoEngine::SUBSTITUTION_BOX_CBR);
