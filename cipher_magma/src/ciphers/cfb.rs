...
mod tests {
    ...
    fn decrypt_cfb_gost_r_34_13_2015() {
        ...
        encrypted.extend_from_slice(&ENCRYPTED1_CFB_GOST_R3413_2015.to_be_bytes());
        encrypted.extend_from_slice(&ENCRYPTED2_CFB_GOST_R3413_2015.to_be_bytes());
        encrypted.extend_from_slice(&ENCRYPTED3_CFB_GOST_R3413_2015.to_be_bytes());
        encrypted.extend_from_slice(&ENCRYPTED4_CFB_GOST_R3413_2015.to_be_bytes());
